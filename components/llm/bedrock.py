...
class AmazonBedrockComponent(LCModelComponent):
    ...
    if "us.anthropic.claude-sonnet-4-5-20250929-v1:0" not in AWS_MODEL_IDs:
        AWS_MODEL_IDs.append("us.anthropic.claude-sonnet-4-5-20250929-v1:0")
    
    if "us.anthropic.claude-sonnet-4-20250514-v1:0" not in AWS_MODEL_IDs:
            AWS_MODEL_IDs.append("us.anthropic.claude-sonnet-4-20250514-v1:0")
    inputs = [
