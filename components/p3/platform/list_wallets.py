"""
P3 List Wallets Platform Component

This component lists wallets from an organization in the P3 Platform API by making a GET request
...
class P3ListWalletsPlatformComponent(Component):
    display_name = "P3 List Wallets Platform"
    description = "List wallets from an organization in the P3 Platform API"
    icon = "wallet"
    name = "P3ListWalletsPlatformComponent"
    ...
    outputs = [
        Output(name="response", display_name="Response", method="list_wallets"),
    ]
