"""
P3 List Cards V1 Component

This component lists cards from an organization in the P3 Banking API by making a GET request
to the /realms/:realmId/organizations/:organizationId/cards endpoint (V1 version).
"""
...
class P3ListCardsV1Component(Component):
    display_name = "P3 List Cards V1"
    description = "List cards from an organization in the P3 Banking API (V1 version)"
    icon = "credit-card"
    name = "P3ListCardsV1Component"
    ...
    outputs = [
        Output(name="response", display_name="Response", method="list_cards_v1"),
    ]
    
    def list_cards_v1(self) -> Data:
        """
        List cards from an organization in the P3 Banking API (V1 version).
