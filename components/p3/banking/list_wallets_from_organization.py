"""
P3 List Wallets From Organization Component

This component lists wallets from an organization in the P3 Banking API by making a GET request
to the /v2/realms/:realmId/organizations/:organizationId/wallets endpoint.
"""
...
class P3ListWalletsFromOrganizationComponent(Component):
    display_name = "P3 List Wallets From Organization"
    description = "List wallets from an organization in the P3 Banking API"
    icon = "list"
    name = "P3ListWalletsFromOrganizationComponent"
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="The organization ID to list wallets from",
            required=True,
        ),
        SecretStrInput(
            name="access_token",
    ...
    outputs = [
        Output(name="response", display_name="Response", method="list_wallets_from_organization"),
    ]
    
    def list_wallets_from_organization(self) -> Data:
        """
        List wallets from an organization in the P3 Banking API.
        
        Returns:
            Data: Contains the list of wallets from the API
        """
