"""
P3 Get Card By ID Component

This component retrieves card information from the P3 Banking API by making a GET request
to the /v2/realms/:realmId/organizations/:organizationId/accounts/:accountId/wallets/:walletId/cards/:cardId endpoint.
"""
...
class P3GetCardByIdComponent(Component):
    display_name = "P3 Get Card By ID"
    description = "Get card information by ID from the P3 Banking API"
    icon = "credit-card"
    name = "P3GetCardByIdComponent"
    ...
    outputs = [
        Output(name="response", display_name="Response", method="get_card_by_id"),
    ]
    
    def get_card_by_id(self) -> Data:
        """
        Get card information by ID from the P3 Banking API.
