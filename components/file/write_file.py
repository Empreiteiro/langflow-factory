...
class FileComponent(BaseFileComponent):
    ...
    # xls/xlsx are excluded: they work in standard mode via pandas (Structured Content output).
    ...
    # Structured table formats supported without Docling (pandas in standard mode).
    STRUCTURED_TABLE_EXTENSIONS = ["xls", "xlsx"]

    # Docling-supported/compatible extensions; TEXT_FILE_TYPES are supported by the base loader.
    VALID_EXTENSIONS = [
        *TEXT_EXTENSIONS,
        *DOCLING_ONLY_EXTENSIONS,
        *STRUCTURED_TABLE_EXTENSIONS,
    ]
    ...
    def _is_docling_compatible(self, file_path: str) -> bool:
        ...
        xls/xlsx are excluded: they are handled in standard mode via pandas.
        """
        docling_exts = (
            ".adoc",
            ".asciidoc",
    ...
    def process_files(
        ...
        def process_file_standard(file_path: str, *, silent_errors: bool = False) -> Data | None:
            # xlsx/xls are handled via pandas in load_files_structured; return minimal Data with path.
