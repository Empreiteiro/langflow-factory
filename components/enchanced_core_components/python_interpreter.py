...
class PythonREPLComponent(Component):
    ...
    def run_python_repl(self) -> Data:
        try:
            # Extract code - handle MultilineInput and various input types
            code_to_run = getattr(self.python_code, 'text', 
                         getattr(self.python_code, 'content', 
                         self.python_code if isinstance(self.python_code, str) else str(self.python_code)))
