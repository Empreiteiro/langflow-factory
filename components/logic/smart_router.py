    ...
    def update_outputs(self, frontend_node: dict, field_name: str, field_value: Any) -> dict:
        ...
        if field_name in {"routes", "enable_else_output"}:
            ...
            if field_name == "routes":
                ...
                # When enable_else_output changes, get routes from component state
            ...
            # Get enable_else from field_value if this is the field being updated, otherwise from component state
            if field_name == "enable_else_output":
                enable_else = bool(field_value)
            else:
                # When routes change, check current state of enable_else_output
                enable_else = bool(getattr(self, "enable_else_output", False))
